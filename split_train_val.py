...
#按照split_ratio=0.2比例，将数据集的80%分为训练集，剩余20%分为验证集。
#保存为符合YOLO格式的文件夹，主文件夹img_path/result/train和img_path/result/val,子文件夹train和val文件夹内有对应的images和labels。
parser=argparse.ArgumentParser()
parser.add_argument("--img_path",default="/home/donggua/文档/datasets/needle/images",type=str,help="img path")
parser.add_argument("--label_path",default='/home/donggua/文档/datasets/needle/labels',type=str,help='xml path')
...
#分割trian和val数据集,resaved_data是否复制图像和标签到新建文件夹
